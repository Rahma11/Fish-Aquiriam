...
float _fish5Xaxis=2.7f;
float _fish5Yaxis=0.6f;

float _fish6Xaxis=2.4f;
float _fish6Yaxis=0.7f;

float _fish7Xaxis=-0.7f;
float _fish7Yaxis=0.7f;

float _insect1Xaxis=-2.0f;
float _insect1Yaxis=1.1f;

float _insect2Xaxis=-2.0f;
float _insect2Yaxis=-1.5f;
...
void update(int value)
{
    ...
    _fish5Yaxis=sin(_fish5Xaxis)-0.5;
    ...
    _fish6Xaxis+=0.009;
    _fish6Yaxis=sin(_fish6Xaxis+0.5);
    if(_fish6Xaxis<0)
    {
        _fish6Yaxis*=(-1);
    }
    ...
    _fish7Xaxis+=0.008;
    _fish7Yaxis=sin(_fish7Xaxis+0.5);
    ...
    _insect1Xaxis+=0.008;
    _insect1Yaxis=sin(_insect1Xaxis+0.3);
...
void DrawInsect1()
{
    glScalef(0.2f, 0.1f, 0.0f); //THIS IS TO SCALE THE FISH
    glTranslatef(_insect1Xaxis, _insect1Yaxis, 0.0); //THIS IS TO TRANSLATING THE FISH
    glRotatef(180.0, 0.0, 1.0, 0.0);
    glPushMatrix();


    glColor3f(0.0, 0.0, 0.0); //black insect
    glBegin(GL_POLYGON);
...
void DrawFish7()
{
    ...
    glTranslatef(_fish7Xaxis, _fish7Yaxis, 0.0); //THIS IS TO TRANSLATING THE FISH
    glRotatef(180.0, 0.0, 1.0, 0.0);
    glPushMatrix();
...
{
    glScalef(1.3f, 1.0f, 0.0f); //THIS IS TO SCALE THE FISH
    glTranslatef(_fish6Xaxis, _fish6Yaxis, 0.0); //THIS IS TO TRANSLATING THE FISH
    glRotatef(180.0, 0.0, 1.0, 0.0);
    glPushMatrix();

    //fishTail
    glColor3f(1.0, 0.0, 1.0);//yellow fish
    glBegin(GL_POLYGON);
...
void DrawFish5()
{
    glScalef(1.7f, 1.5f, 0.0f); //THIS IS TO SCALE THE FISH
    glTranslatef(_fish5Xaxis, _fish5Yaxis, 0.0); //THIS IS TO TRANSLATING THE FISH
    glRotatef(180.0, 0.0, 1.0, 0.0);
    glPushMatrix();
...
int main(int argc, char** argv)
{
    ...
    glutTimerFunc(25, update, 0); //THIS IS THE UPDATE FUNCTOIN
    glutMainLoop();
    return 0;
}
